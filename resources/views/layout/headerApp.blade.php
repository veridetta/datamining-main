...
<head>
    <meta charset="utf-8" />
    <title>Machine Learning Fuzzy C-Means</title>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="javascript:void(0)" id="topnav-layout" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="mdi mdi-database mr-2"></i>Data Master Fuzzy<div class="arrow-down"></div>
                                </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)" onclick="renderPage('app/apriori/setup', 'Machine Learning Fuzzy C Means')">
                                    <i class="mdi mdi-equalizer-outline mr-2"></i>Proses Clustering Data
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)" onclick="renderPage('app/user/data', 'Data User')">
